...
import {IPoolManager} from "../../external_deps/uniswap/v4-core/contracts/interfaces/IPoolManager.sol";
import {PoolId, PoolIdLibrary} from "../../external_deps/uniswap/v4-core/contracts/types/PoolId.sol";
import {Hooks} from "../../external_deps/uniswap/v4-core/contracts/libraries/Hooks.sol";
...
import {PoolKey} from "../../external_deps/uniswap/v4-core/contracts/types/PoolKey.sol";
...
contract LiquidatorHook is BaseHook {
        ...
        returns (bytes4)
    {
        ...
        return LiquidatorHook.afterInitialize.selector;
    }
    ...
    function afterSwap(
        ...
        if (lower > upper) return LiquidatorHook.afterSwap.selector;
        ...
        return LiquidatorHook.afterSwap.selector;
    }
